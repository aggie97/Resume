...
const Portfolio = () => {
  return (
    <div>
      <article id="ad1c5302-5a47-4abe-8b60-f6ab44c9b859" class="page sans">
        <header>
          <h1 class="page-title">포트폴리오</h1>
        </header>
        <hr />
        <div class="page-body">
          <h3 id="cdd16dde-cac3-4d78-8033-6a27f7081d41" class="">
            <span style={{ borderBottom: "0.05em solid" }}>
              <strong>ONF(On And Off)</strong>
            </span>
            <strong> : </strong>
            <mark class="highlight-gray">Team Project</mark>
          </h3>
          <p id="54656f97-32b1-4420-a61c-6ce76c800c44" class="">
          ...
          <p id="d115ec2f-c5b3-4458-822c-10c98ceefc61" class="">
            <mark class="highlight-gray">
              2022.11.28 ~ 2023.01.27(1차 마무리)
            </mark>
          </p>
          <div id="d329cbd4-6890-468d-b3ba-27b6ac6c229f" class="column-list">
            <div
            ...
            <div
              ...
              class="column"
            >
              <figure id="7d4fa18e-fc1b-42e0-8274-46329199da9f" class="image">
          ...
          <h3 id="8eefd8a0-c78c-4164-bafe-c4e3e6f16465" class="">
            Skill Stack
          </h3>
          <p id="15636c55-a977-4192-83b8-748071608662" class="">
          ...
          <h3 id="156b264d-ea09-4c27-bc14-c972be0d31dd" class="">
            What I Did
          </h3>
          <p id="72b34aaf-a867-454d-bce4-10bc1aec22af" class="">
            <strong>관리, 프로필 페이지</strong>
          </p>
          <ul id="f5e3bb0f-8d22-485d-b555-71dc4b53f191" class="bulleted-list">
            <li style={{ listStyleType: "disc" }}>
              GraphQL을 통해 각 탭에 fit한 data 요청
            </li>
          </ul>
          <ul id="bd8775f1-8d67-4e3a-a046-b8b62a283e8c" class="bulleted-list">
            <li style={{ listStyleType: "disc" }}>
              카카오맵 API를 이용하여 위치 기반 데이터를 가공하여 전달 및 요청
            </li>
          </ul>
          <ul id="8b2fc7fb-68d3-47e1-8420-f923e8599b42" class="bulleted-list">
            <li style={{ listStyleType: "disc" }}>
              react-hook-form을 이용하여 form 관련 파일의 코드 라인 50% 단축
            </li>
          </ul>
          <ul id="fdede19c-affb-4d31-81f3-740618937c88" class="bulleted-list">
            <li style={{ listStyleType: "disc" }}>
              yup을 이용한 유효성 검증으로 유지 보수 개선
            </li>
          </ul>
          <ul id="3504354d-a464-4d03-bb61-23727dd27a25" class="bulleted-list">
            <li style={{ listStyleType: "disc" }}>
              Container-Presenter 패턴에 Atomic 패턴을 섞어 유지 보수 개선
            </li>
          </ul>
          <p id="d819b3a5-2572-4ea6-8bc0-76d8abc76bee" class="">
            <strong>핵심 공통 컴포넌트 설계 및 구현</strong>
          </p>
          <ul id="9c834b02-f217-4772-9520-4ced0ab47af5" class="bulleted-list">
            <li style={{ listStyleType: "disc" }}>
          ...
          <p id="2ee23611-e55b-46db-9fae-edb343ac2d0f" class=""></p>
          <p id="61a0edb8-5f4e-49c6-95d2-41e78eff4db8" class=""></p>
          <p id="f43f49ee-9c01-4d59-9281-b3034b8bdd5c" class=""></p>
          <h2 id="4705c22c-66e4-409e-80cb-e75e84193953" class="">
            <span style={{ borderBottom: "0.05em solid" }}>BUSKER</span> :
            <mark class="highlight-gray">Team Project</mark>
          </h2>
          <hr id="6108bd47-e6b8-4251-ab14-a8195fffb9e9" />
          <p id="59a39d5e-5250-4b01-8537-c4bddf5126ad" class="">
            버스커와 버스킹을 즐기는 관객들을 이어주는 버스킹 위치 정보 제공
            플랫폼.
          </p>
          <p id="7f1aec68-81e5-4440-a10a-d72e46a315f8" class="">
            부트 캠프에서 4주 동안 총 6 명의 팀원이 함께 만든 프로젝트로 기획,
            디자인, 개발을 분배하여 진행.
          </p>
          <figure
            class="block-color-purple_background callout"
          ...
          <h3 id="a0e3858d-add2-4aac-922e-f9381dfd03c9" class="">
            Skill Stack
          </h3>
          <p id="175289b0-1b64-405c-89a4-0b1de3af4268" class="">
            <code>React</code>, <code>TypeScript</code>, <code>Next.js</code>,
            <code>Emotion</code>, <code>GraphQL</code>, <code>Recoil</code>
          </p>
          <p id="82c9ef1b-3cb6-4e6e-a14a-c1529ebf7548" class=""></p>
          <h3 id="0820383a-59ce-40ed-a309-a4f34d7e6494" class="">
            What I Did
          </h3>
          <ul id="c973cf73-ba3d-451b-a4ba-3671b2aa1c83" class="bulleted-list">
            <li style={{ listStyleType: "disc" }}>
              <strong>
          ...
          <ul id="3a5bfec3-9ceb-4b3c-82af-b738e0570647" class="bulleted-list">
            <li style={{ listStyleType: "disc" }}>
              <strong>디자이너 소통 담당</strong>
            </li>
          </ul>
          <ul id="8718ccc8-1526-4d70-9b6e-f4ae42e2546c" class="bulleted-list">
            <li style={{ listStyleType: "disc" }}>
              <strong>배포</strong>
              <ul
          ...
          <ul id="a34e42a2-821f-47af-adea-76b7af076126" class="bulleted-list">
            <li style={{ listStyleType: "disc" }}>
              <strong>
          ...
          <p id="7881df71-1f85-4b67-815c-b8e334b906f1" class=""></p>
          <p id="046ca147-393d-4252-a826-5c62eac3b1d8" class="">
            <strong>회고</strong>
          </p>
          ...
          <p id="804dde86-a33a-44c3-bec5-78cd414f094b" class=""></p>
          <p id="8cf0f9c7-efe7-487a-b821-a8a670be747e" class=""></p>
          <h2 id="f3284635-19ca-4229-b2ac-00049e1c08fb" class="">
            <span style={{ borderBottom: "0.05em solid" }}>중고마켓</span> :
            <mark class="highlight-gray">Personal Project</mark>
          </h2>
          <hr id="d79fad9b-36a2-4e47-bb29-3e66986e7a11" />
          <p id="17c93db2-8eb0-4866-a518-54d90a4571a9" class="">
          ...
          <figure id="37e1a2bd-3276-462e-bf6f-19f9c9b25f44">
            <div class="source">https://github.com/aggie97/used_market</div>
          </figure>
          <h3 id="4941ac6f-1c43-43dd-ace2-2045c25aaf2a" class="">
            Skill Stack
          </h3>
          <p id="88416aef-7b75-4d9f-9202-a88b1b58cd6e" class="">
            <code>React</code>, <code>TypeScript</code>, <code>Next.js</code>,
            <code>Emotion</code>, <code>GraphQL</code>, <code>Recoil</code>
          </p>
          <p id="f4d0bd43-0193-441b-b18b-760c3833c6b6" class=""></p>
          <h3 id="d4fd5a6c-d45d-4e20-b5bc-fe2741b3f76a" class="">
            What I Did
          </h3>
          <ul id="c70287f1-d934-4774-b4d9-c6984c50a85e" class="bulleted-list">
            <li style={{ listStyleType: "disc" }}>
              input type option과 label을 이용한 pagination 버튼 구현
            </li>
          </ul>
          <ul id="4a13af2d-1421-4f66-b8d7-2840a9054c47" class="bulleted-list">
            <li style={{ listStyleType: "disc" }}>
              제목 검색 API에 lodash의 debounce를 사용하여 연속적인 api 요청
              방지
            </li>
          </ul>
          <ul id="cd0a7499-4da6-4a79-9a8f-f3841409038e" class="bulleted-list">
            <li style={{ listStyleType: "disc" }}>
              중고 상품 목록 무한 스크롤 구현
            </li>
          </ul>
          <ul id="5e199e02-1bd3-42f5-aee5-3b89296611a1" class="bulleted-list">
            <li style={{ listStyleType: "disc" }}>
              daum-post-code를 이용하여 우편번호와 주소 검색
            </li>
          </ul>
          <ul id="ea1256e9-e754-4732-9a97-599ff92c8746" class="bulleted-list">
            <li style={{ listStyleType: "disc" }}>
              최상단에서 아래로 스크롤 시, sticky 장바구니 목록
              표시(Intersection-Observer)
            </li>
          </ul>
          <p id="66b1027f-eecd-44aa-943d-943bfbd4df9f" class=""></p>
        </div>
      </article>
    </div>
  );
